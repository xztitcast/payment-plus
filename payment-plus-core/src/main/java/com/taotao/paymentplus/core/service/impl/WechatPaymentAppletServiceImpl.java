...
@Slf4j
@Service
public class WechatPaymentAppletServiceImpl extends WeChatPaymentSupport implements PaymentService {
	
	private WechatGlobalConfiguration configuration;

	public WechatPaymentAppletServiceImpl(WechatGlobalConfiguration configuration) {
		super(configuration.getApplet());
