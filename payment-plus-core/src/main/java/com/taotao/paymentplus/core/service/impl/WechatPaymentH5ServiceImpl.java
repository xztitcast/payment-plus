...
@Slf4j
@Service
public class WechatPaymentH5ServiceImpl extends WeChatPaymentSupport implements PaymentService {

	private WechatGlobalConfiguration configuration;
	
	public WechatPaymentH5ServiceImpl(WechatGlobalConfiguration configuration) {
		super(configuration.getH5());
